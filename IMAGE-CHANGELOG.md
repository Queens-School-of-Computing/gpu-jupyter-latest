...
**Build:** 20260313 nightly ✅ 11m 32s · 20260424 nightly ✅ 13m 1s — warnings in build log: 18
**Changed:** `claude_code` 2.1.281 → 2.1.283 · `code_server` 4.138.0 → 4.139.1 · `uv` 0.12.18 → 0.12.19 · `vscode` 1.139.0 → 1.139.1
**Known issues (for the versions in this build):**
- `claude_code` 2.1.283 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `code_server` 4.139.1 — [release notes](https://github.com/coder/code-server/releases/tag/v4.139.1) — none listed in release notes
- `uv` 0.12.19 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.19) — none listed in release notes
- `vscode` 1.139.1 — [release notes](https://code.visualstudio.com/updates/v1_139) — see VS Code release notes

<details>
<summary>Full component list (2026-09-26)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 154.0.8037.57 | nightly tools |
| `chromedriver` | 154.0.8037.57 | nightly tools |
| `claude_code` | 2.1.283 | nightly tools |
| `code_server` | 4.139.1 | nightly tools |
| `ollama` | 0.34.4 | nightly tools |
| `opencode` | 1.18.32 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.19 | nightly tools |
| `vscode` | 1.139.1 | nightly tools |
...
**Build:** 20260313 nightly ✅ 9m 55s · 20260424 nightly ✅ 12m 2s — warnings in build log: 18
**Changed:** `claude_code` 2.1.280 → 2.1.281 · `ollama` 0.34.3 → 0.34.4 · `vscode` 1.138.0 → 1.139.0
**Known issues (for the versions in this build):**
- `claude_code` 2.1.281 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `ollama` 0.34.4 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.34.4) — none listed in release notes
- `vscode` 1.139.0 — [release notes](https://code.visualstudio.com/updates/v1_139) — see VS Code release notes

<details>
<summary>Full component list (2026-09-24)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 154.0.8037.57 | nightly tools |
| `chromedriver` | 154.0.8037.57 | nightly tools |
| `claude_code` | 2.1.281 | nightly tools |
| `code_server` | 4.138.0 | nightly tools |
| `ollama` | 0.34.4 | nightly tools |
| `opencode` | 1.18.32 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.18 | nightly tools |
| `vscode` | 1.139.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
| `jupyterlab_spellchecker` | 0.8.4 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 6m 52s · 20260424 nightly ✅ 7m 37s — warnings in build log: 14
**Changed:** `chrome` 153.0.8010.52 → 154.0.8037.57 · `chromedriver` 153.0.8010.52 → 154.0.8037.57 · `claude_code` 2.1.278 → 2.1.280 · `ollama` 0.34.2 → 0.34.3 · `uv` 0.12.17 → 0.12.18
**Known issues (for the versions in this build):**
- `chrome` 154.0.8037.57 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `chromedriver` 154.0.8037.57 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `claude_code` 2.1.280 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `ollama` 0.34.3 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.34.3) — none listed in release notes
- `uv` 0.12.18 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.18) — none listed in release notes

<details>
<summary>Full component list (2026-09-23)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 154.0.8037.57 | nightly tools |
| `chromedriver` | 154.0.8037.57 | nightly tools |
| `claude_code` | 2.1.280 | nightly tools |
| `code_server` | 4.138.0 | nightly tools |
| `ollama` | 0.34.3 | nightly tools |
| `opencode` | 1.18.32 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.18 | nightly tools |
| `vscode` | 1.138.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
| `jupyterlab_spellchecker` | 0.8.4 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 4m 36s · 20260424 nightly ✅ 5m 18s — warnings in build log: 10
**Changed:** `opencode` 1.18.31 → 1.18.32
**Known issues (for the versions in this build):**
- `opencode` 1.18.32 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.32) — none listed in release notes

<details>
<summary>Full component list (2026-09-22)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.52 | nightly tools |
| `chromedriver` | 153.0.8010.52 | nightly tools |
| `claude_code` | 2.1.278 | nightly tools |
| `code_server` | 4.138.0 | nightly tools |
| `ollama` | 0.34.2 | nightly tools |
| `opencode` | 1.18.32 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.17 | nightly tools |
| `vscode` | 1.138.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 8m 19s · 20260424 nightly ✅ 8m 57s — warnings in build log: 18
**Changed:** `code_server` 4.137.0 → 4.138.0
**Known issues (for the versions in this build):**
- `code_server` 4.138.0 — [release notes](https://github.com/coder/code-server/releases/tag/v4.138.0) — none listed in release notes

<details>
<summary>Full component list (2026-09-20)</summary>
...
| `code_server` | 4.138.0 | nightly tools |
| `ollama` | 0.34.2 | nightly tools |
| `opencode` | 1.18.31 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.17 | nightly tools |
| `vscode` | 1.138.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 4m 22s · 20260424 nightly ✅ 4m 15s — warnings in build log: 10
**Changed:** `claude_code` 2.1.276 → 2.1.278 · `uv` 0.12.16 → 0.12.17
**Known issues (for the versions in this build):**
- `claude_code` 2.1.278 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `uv` 0.12.17 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.17) — none listed in release notes

<details>
<summary>Full component list (2026-09-19)</summary>
...
| `chromedriver` | 153.0.8010.52 | nightly tools |
| `claude_code` | 2.1.278 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.2 | nightly tools |
| `opencode` | 1.18.31 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.17 | nightly tools |
...
**Build:** 20260313 nightly ✅ 6m 7s · 20260424 nightly ✅ 7m 32s — warnings in build log: 14
**Changed:** `chrome` 153.0.8010.47 → 153.0.8010.52 · `chromedriver` 153.0.8010.47 → 153.0.8010.52 · `claude_code` 2.1.274 → 2.1.276 · `ollama` 0.34.1 → 0.34.2 · `uv` 0.12.15 → 0.12.16
**Known issues (for the versions in this build):**
- `chrome` 153.0.8010.52 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `chromedriver` 153.0.8010.52 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `claude_code` 2.1.276 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `ollama` 0.34.2 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.34.2) — none listed in release notes
- `uv` 0.12.16 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.16) — none listed in release notes

<details>
<summary>Full component list (2026-09-18)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.52 | nightly tools |
| `chromedriver` | 153.0.8010.52 | nightly tools |
| `claude_code` | 2.1.276 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.2 | nightly tools |
| `opencode` | 1.18.31 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.16 | nightly tools |
| `vscode` | 1.138.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 9m 48s · 20260424 nightly ✅ 10m 43s — warnings in build log: 18
**Changed:** `claude_code` 2.1.273 → 2.1.274 · `vscode` 1.137.0 → 1.138.0
**Known issues (for the versions in this build):**
- `claude_code` 2.1.274 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `vscode` 1.138.0 — [release notes](https://code.visualstudio.com/updates/v1_138) — see VS Code release notes

<details>
<summary>Full component list (2026-09-17)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.47 | nightly tools |
| `chromedriver` | 153.0.8010.47 | nightly tools |
| `claude_code` | 2.1.274 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.1 | nightly tools |
| `opencode` | 1.18.31 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.15 | nightly tools |
| `vscode` | 1.138.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 8m 29s · 20260424 nightly ✅ 6m 50s — warnings in build log: 14
**Changed:** `chrome` 153.0.8010.36 → 153.0.8010.47 · `chromedriver` 153.0.8010.36 → 153.0.8010.47 · `claude_code` 2.1.272 → 2.1.273 · `ollama` 0.34.0 → 0.34.1 · `uv` 0.12.14 → 0.12.15
**Known issues (for the versions in this build):**
- `chrome` 153.0.8010.47 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `chromedriver` 153.0.8010.47 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `claude_code` 2.1.273 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `ollama` 0.34.1 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.34.1) — none listed in release notes
- `uv` 0.12.15 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.15) — none listed in release notes

<details>
<summary>Full component list (2026-09-16)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.47 | nightly tools |
| `chromedriver` | 153.0.8010.47 | nightly tools |
| `claude_code` | 2.1.273 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.1 | nightly tools |
| `opencode` | 1.18.31 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.15 | nightly tools |
| `vscode` | 1.137.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
| `jupyterlab_spellchecker` | 0.8.4 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 4m 25s · 20260424 nightly ✅ 5m 34s — warnings in build log: 10
**Changed:** `claude_code` 2.1.270 → 2.1.272 · `opencode` 1.18.30 → 1.18.31 · `uv` 0.12.13 → 0.12.14
**Known issues (for the versions in this build):**
- `claude_code` 2.1.272 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `opencode` 1.18.31 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.31) — none listed in release notes
- `uv` 0.12.14 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.14) — none listed in release notes

<details>
<summary>Full component list (2026-09-15)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.36 | nightly tools |
| `chromedriver` | 153.0.8010.36 | nightly tools |
| `claude_code` | 2.1.272 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.0 | nightly tools |
| `opencode` | 1.18.31 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.14 | nightly tools |
| `vscode` | 1.137.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 5m 33s · 20260424 nightly ✅ 3m 50s — warnings in build log: 10
**Changed:** `claude_code` 2.1.269 → 2.1.270
**Known issues (for the versions in this build):**
- `claude_code` 2.1.270 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)

<details>
<summary>Full component list (2026-09-13)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.36 | nightly tools |
| `chromedriver` | 153.0.8010.36 | nightly tools |
| `claude_code` | 2.1.270 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.0 | nightly tools |
| `opencode` | 1.18.30 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.13 | nightly tools |
| `vscode` | 1.137.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 4m 15s · 20260424 nightly ✅ 3m 59s — warnings in build log: 10
**Changed:** `claude_code` 2.1.268 → 2.1.269
**Known issues (for the versions in this build):**
- `claude_code` 2.1.269 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)

<details>
<summary>Full component list (2026-09-12)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.36 | nightly tools |
| `chromedriver` | 153.0.8010.36 | nightly tools |
| `claude_code` | 2.1.269 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.0 | nightly tools |
| `opencode` | 1.18.30 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
...
**Build:** 20260313 nightly ✅ 7m 42s · 20260424 nightly ✅ 8m 2s — warnings in build log: 18
**Changed:** `claude_code` 2.1.267 → 2.1.268 · `code_server` 4.136.2 → 4.137.0 · `ollama` 0.33.3 → 0.34.0 · `uv` 0.12.12 → 0.12.13
**Known issues (for the versions in this build):**
- `claude_code` 2.1.268 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `code_server` 4.137.0 — [release notes](https://github.com/coder/code-server/releases/tag/v4.137.0) — none listed in release notes
- `ollama` 0.34.0 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.34.0) — none listed in release notes
- `uv` 0.12.13 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.13) — none listed in release notes

<details>
<summary>Full component list (2026-09-11)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.36 | nightly tools |
| `chromedriver` | 153.0.8010.36 | nightly tools |
| `claude_code` | 2.1.268 | nightly tools |
| `code_server` | 4.137.0 | nightly tools |
| `ollama` | 0.34.0 | nightly tools |
| `opencode` | 1.18.30 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
...
**Build:** 20260313 nightly ✅ 9m 46s · 20260424 nightly ✅ 10m 37s — warnings in build log: 78
**Changed:** `claude_code` 2.1.266 → 2.1.267 · `selenium` 4.48.0 → 4.49.0 · `uv` 0.12.11 → 0.12.12 · `vscode` 1.136.2 → 1.137.0
**Known issues (for the versions in this build):**
- `claude_code` 2.1.267 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `selenium` 4.49.0 — [release notes](https://github.com/SeleniumHQ/selenium/releases/tag/selenium-4.49.0) — none listed in release notes
- `uv` 0.12.12 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.12) — none listed in release notes
- `vscode` 1.137.0 — [release notes](https://code.visualstudio.com/updates/v1_137) — see VS Code release notes

<details>
<summary>Full component list (2026-09-10)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.36 | nightly tools |
| `chromedriver` | 153.0.8010.36 | nightly tools |
| `claude_code` | 2.1.267 | nightly tools |
| `code_server` | 4.136.2 | nightly tools |
| `ollama` | 0.33.3 | nightly tools |
| `opencode` | 1.18.30 | nightly tools |
| `selenium` | 4.49.0 | nightly tools |
| `uv` | 0.12.12 | nightly tools |
| `vscode` | 1.137.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 9m 22s · 20260424 nightly ✅ 10m 35s — warnings in build log: 18
**Changed:** `chrome` 152.0.7977.82 → 153.0.8010.36 · `chromedriver` 152.0.7977.82 → 153.0.8010.36 · `claude_code` 2.1.263 → 2.1.266 · `code_server` 4.135.0 → 4.136.2 · `opencode` 1.18.29 → 1.18.30 · `uv` 0.12.10 → 0.12.11 · `vscode` 1.136.1 → 1.136.2
**Known issues (for the versions in this build):**
- `chrome` 153.0.8010.36 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `chromedriver` 153.0.8010.36 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `claude_code` 2.1.266 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `code_server` 4.136.2 — [release notes](https://github.com/coder/code-server/releases/tag/v4.136.2) — none listed in release notes
- `opencode` 1.18.30 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.30) — none listed in release notes
- `uv` 0.12.11 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.11) — none listed in release notes
- `vscode` 1.136.2 — [release notes](https://code.visualstudio.com/updates/v1_136) — see VS Code release notes

<details>
<summary>Full component list (2026-09-09)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 153.0.8010.36 | nightly tools |
| `chromedriver` | 153.0.8010.36 | nightly tools |
| `claude_code` | 2.1.266 | nightly tools |
| `code_server` | 4.136.2 | nightly tools |
| `ollama` | 0.33.3 | nightly tools |
| `opencode` | 1.18.30 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.11 | nightly tools |
| `vscode` | 1.136.2 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
| `jupyterlab_spellchecker` | 0.8.4 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 3m 44s · 20260424 nightly ✅ 4m 55s — warnings in build log: 10
**Changed:** `claude_code` 2.1.261 → 2.1.263
**Known issues (for the versions in this build):**
- `claude_code` 2.1.263 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)

<details>
<summary>Full component list (2026-09-06)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.82 | nightly tools |
| `chromedriver` | 152.0.7977.82 | nightly tools |
| `claude_code` | 2.1.263 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.3 | nightly tools |
| `opencode` | 1.18.29 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.10 | nightly tools |
| `vscode` | 1.136.1 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
| `jupyterlab_spellchecker` | 0.8.4 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 3m 48s · 20260424 nightly ✅ 5m 26s — warnings in build log: 10
**Changed:** `claude_code` 2.1.260 → 2.1.261 · `opencode` 1.18.27 → 1.18.29 · `uv` 0.12.9 → 0.12.10
**Known issues (for the versions in this build):**
- `claude_code` 2.1.261 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `opencode` 1.18.29 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.29) — none listed in release notes
- `uv` 0.12.10 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.10) — none listed in release notes

<details>
<summary>Full component list (2026-09-05)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.82 | nightly tools |
| `chromedriver` | 152.0.7977.82 | nightly tools |
| `claude_code` | 2.1.261 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.3 | nightly tools |
| `opencode` | 1.18.29 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
...
**Build:** 20260313 nightly ✅ 10m 45s · 20260424 nightly ✅ 9m 24s — warnings in build log: 18
**Changed:** `chrome` 152.0.7977.75 → 152.0.7977.82 · `chromedriver` 152.0.7977.75 → 152.0.7977.82 · `claude_code` 2.1.259 → 2.1.260 · `ollama` 0.33.2 → 0.33.3 · `vscode` 1.136.0 → 1.136.1
**Known issues (for the versions in this build):**
- `chrome` 152.0.7977.82 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `chromedriver` 152.0.7977.82 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `claude_code` 2.1.260 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `ollama` 0.33.3 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.33.3) — none listed in release notes
- `vscode` 1.136.1 — [release notes](https://code.visualstudio.com/updates/v1_136) — see VS Code release notes

<details>
<summary>Full component list (2026-09-04)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.82 | nightly tools |
| `chromedriver` | 152.0.7977.82 | nightly tools |
| `claude_code` | 2.1.260 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.3 | nightly tools |
| `opencode` | 1.18.27 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.9 | nightly tools |
| `vscode` | 1.136.1 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 10m 40s · 20260424 nightly ✅ 10m 51s — warnings in build log: 18
**Changed:** `claude_code` 2.1.258 → 2.1.259 · `opencode` 1.18.26 → 1.18.27 · `vscode` 1.135.0 → 1.136.0
**Known issues (for the versions in this build):**
- `claude_code` 2.1.259 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `opencode` 1.18.27 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.27) — none listed in release notes
- `vscode` 1.136.0 — [release notes](https://code.visualstudio.com/updates/v1_136) — see VS Code release notes

<details>
<summary>Full component list (2026-09-03)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.75 | nightly tools |
| `chromedriver` | 152.0.7977.75 | nightly tools |
| `claude_code` | 2.1.259 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.2 | nightly tools |
| `opencode` | 1.18.27 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.9 | nightly tools |
| `vscode` | 1.136.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
| `jupyterlab_spellchecker` | 0.8.4 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 7m 31s · 20260424 nightly ✅ 6m 58s — warnings in build log: 14
**Changed:** `chrome` 152.0.7977.64 → 152.0.7977.75 · `chromedriver` 152.0.7977.64 → 152.0.7977.75 · `claude_code` 2.1.252 → 2.1.258 · `opencode` 1.18.25 → 1.18.26 · `uv` 0.12.8 → 0.12.9
**Known issues (for the versions in this build):**
- `chrome` 152.0.7977.75 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `chromedriver` 152.0.7977.75 — [release notes](https://chromereleases.googleblog.com/search/label/Stable%20updates) — see Chrome stable release blog
- `claude_code` 2.1.258 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `opencode` 1.18.26 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.26) — none listed in release notes
- `uv` 0.12.9 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.9) — none listed in release notes

<details>
<summary>Full component list (2026-09-02)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.75 | nightly tools |
| `chromedriver` | 152.0.7977.75 | nightly tools |
| `claude_code` | 2.1.258 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.2 | nightly tools |
| `opencode` | 1.18.26 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.9 | nightly tools |
...
**Build:** 20260313 nightly ✅ 3m 48s · 20260424 nightly ✅ 4m 8s — warnings in build log: 10
**Changed:** `claude_code` 2.1.251 → 2.1.252 · `uv` 0.12.7 → 0.12.8
**Known issues (for the versions in this build):**
- `claude_code` 2.1.252 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `uv` 0.12.8 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.8) — none listed in release notes

<details>
<summary>Full component list (2026-09-01)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.64 | nightly tools |
| `chromedriver` | 152.0.7977.64 | nightly tools |
| `claude_code` | 2.1.252 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.2 | nightly tools |
| `opencode` | 1.18.25 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.8 | nightly tools |
| `vscode` | 1.135.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 6m 40s · 20260424 nightly ✅ 6m 21s — warnings in build log: 14
**Changed:** `claude_code` 2.1.250 → 2.1.251 · `ollama` 0.33.1 → 0.33.2
**Known issues (for the versions in this build):**
- `claude_code` 2.1.251 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `ollama` 0.33.2 — [release notes](https://github.com/ollama/ollama/releases/tag/v0.33.2) — none listed in release notes

<details>
<summary>Full component list (2026-08-29)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.64 | nightly tools |
| `chromedriver` | 152.0.7977.64 | nightly tools |
| `claude_code` | 2.1.251 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
| `ollama` | 0.33.2 | nightly tools |
| `opencode` | 1.18.25 | nightly tools |
| `selenium` | 4.48.0 | nightly tools |
| `uv` | 0.12.7 | nightly tools |
| `vscode` | 1.135.0 | nightly tools |
| `ipyleaflet` | 0.19.2 | pinned, all images |
| `ipywidgets` | 8.1.5 | pinned, all images |
| `jupyterlab_git` | 0.51.3 | pinned, all images |
...
**Build:** 20260313 nightly ✅ 11m 21s · 20260424 nightly ✅ 12m 5s — warnings in build log: 78
**Changed:** `claude_code` 2.1.247 → 2.1.250 · `code_server` 4.134.0 → 4.135.0 · `opencode` 1.18.23 → 1.18.25 · `selenium` 4.47.0 → 4.48.0 · `uv` 0.12.6 → 0.12.7
**Known issues (for the versions in this build):**
- `claude_code` 2.1.250 — [release notes](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) — see changelog entry (no known-issues section)
- `code_server` 4.135.0 — [release notes](https://github.com/coder/code-server/releases/tag/v4.135.0) — none listed in release notes
- `opencode` 1.18.25 — [release notes](https://github.com/anomalyco/opencode/releases/tag/v1.18.25) — none listed in release notes
- `selenium` 4.48.0 — [release notes](https://github.com/SeleniumHQ/selenium/releases/tag/selenium-4.48.0) — none listed in release notes
- `uv` 0.12.7 — [release notes](https://github.com/astral-sh/uv/releases/tag/0.12.7) — none listed in release notes

<details>
<summary>Full component list (2026-08-28)</summary>

| Component | Version | Scope |
|-----------|---------|-------|
| `chrome` | 152.0.7977.64 | nightly tools |
| `chromedriver` | 152.0.7977.64 | nightly tools |
| `claude_code` | 2.1.250 | nightly tools |
| `code_server` | 4.135.0 | nightly tools |
